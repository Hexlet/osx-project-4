...
//        settingsViewController.delegate = (MainViewController*)self.window.rootViewController;
//        
//        [self.window makeKeyAndVisible];
//        [self.window.rootViewController presentViewController:settingsViewController animated:NO completion:NULL];
//    }
